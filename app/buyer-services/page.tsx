      ...
      <section className="luxury-section bg-muted/30 px-4">
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center mb-12">
            ...
            <div className="bg-gradient-to-br from-blue-100 to-blue-50 rounded-lg p-12 aspect-square flex items-center justify-center">
              <div className="text-center">
                <Globe size={64} className="text-primary mx-auto mb-4" />
                <p className="font-serif text-2xl font-semibold">Global Reach</p>
                <p className="text-muted-foreground mt-2">150+ Countries</p>
              </div>
            </div>
          </div>
        </div>
